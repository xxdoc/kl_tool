								...
								<div class="table">
									<table>
										<thead>
											<tr>
												<th>
													<!-{if $showPage.input.column eq 'item' and $showPage.input.order_by eq 'desc' }->
														<a href="?column=item&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow down">名称/稀有程度</span></a>
													<!-{else if $showPage.input.column eq 'item' and $showPage.input.order_by eq 'asc' }->
														<a href="?column=item&order_by=desc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow up">名称/稀有程度</span></a>
													<!-{else}->
														<a href="?column=item&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow">名称/稀有程度</span></a>
													<!-{/if}->
												</th>
												<th>
													<!-{if $showPage.input.column eq 'quantity' and $showPage.input.order_by eq 'desc' }->
														<a href="?column=quantity&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow down">数量</span></a>
													<!-{else if $showPage.input.column eq 'quantity' and $showPage.input.order_by eq 'asc' }->
														<a href="?column=quantity&order_by=desc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow up">数量</span></a>
													<!-{else}->
														<a href="?column=quantity&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow">数量</span></a>
													<!-{/if}->
												</th>
												<th>
													<div class="table-menu-wrapper">
														<!-{if $showPage.input.column eq 'owner' and $showPage.input.order_by eq 'desc' }->
															<a href="?column=owner&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow"><!-{if $showPage.input.show_level eq 'item_required_level' }->需求等级 <!-{else}->物品等级 <!-{/if}-></span></a>
														<!-{else if $showPage.input.column eq 'owner' and $showPage.input.order_by eq 'asc' }->
															<a href="?column=owner&order_by=desc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow"><!-{if $showPage.input.show_level eq 'item_required_level' }->需求等级 <!-{else}->物品等级 <!-{/if}-></span></a>
														<!-{else}->
															<a href="?column=owner&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow"><!-{if $showPage.input.show_level eq 'item_required_level' }->需求等级 <!-{else}->物品等级 <!-{/if}-></span></a>
														<!-{/if}->
												...
												<th>
													<!-{if $showPage.input.column eq 'timeLeft' and $showPage.input.order_by eq 'desc' }->
														<a href="?column=timeLeft&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow down">剩余时间</span></a>
													<!-{else if $showPage.input.column eq 'timeLeft' and $showPage.input.order_by eq 'asc' }->
														<a href="?column=timeLeft&order_by=desc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow up">剩余时间</span></a>
													<!-{else}->
														<a href="?column=timeLeft&order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow">剩余时间</span></a>
													<!-{/if}->
												</th>
												<th>
													<div class="table-menu-wrapper">
														<!-{if $showPage.input.column neq 'item' and $showPage.input.column neq 'quantity' and $showPage.input.column neq 'owner' and $showPage.input.column neq 'timeLeft' and $showPage.input.order_by eq 'desc' }->
															<a href="?order_by=asc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow down">竞标/一口价</span></a>
														<!-{else if $showPage.input.column neq 'item' and $showPage.input.column neq 'quantity' and $showPage.input.column neq 'owner' and $showPage.input.column neq 'timeLeft' and $showPage.input.order_by eq 'asc' }->
															<a href="?order_by=desc&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow up">竞标/一口价</span></a>
														<!-{else}->
															<a href="?column=buyout&order_by=asc&show_price=all&str_obj=<!-{$showPage.str_obj}->" class="sort-link"><span class="arrow">竞标/一口价</span></a>
														<!-{/if}->
														<a href="javascript:;" class="table-menu-button"
															onclick="Auction.openSubMenu('menu-money', this);"> </a>
														<div id="menu-money" class="table-menu"
															style="display: none">
															<a href="?column=bid&order_by=asc&show_price=all&str_obj=<!-{$showPage.str_obj}->">竞标价格</a>
															<a href="?column=bid&order_by=asc&show_price=per&str_obj=<!-{$showPage.str_obj}->">每件物品出价</a>
															<a href="?column=buyout&order_by=asc&show_price=all&str_obj=<!-{$showPage.str_obj}->">一口价</a>
															<a href="?column=buyout&order_by=asc&show_price=per&str_obj=<!-{$showPage.str_obj}->">每件物品一口价</a>
														</div>
													</div>
												</th>
												<th>
										...
										<tbody>
											...
											<tr id="auction-<!-{$showPage.arrWowAhData[arrid].auc}->"
												...
												<td class="item">
													<a
														href="<!-{$baseSet.url_base}->/item/<!-{$showPage.arrWowAhData[arrid].item}->"
														data-item="q=9&amp;s=<!-{$showPage.arrWowAhData[arrid].seed}->"
														class="icon-frame frame-36" target="block"
														style="background-image: url('<!-{$baseSet.icon_base}->/36/<!-{$showPage.arrWowAhData[arrid].item_icon}->.jpg');">
													</a>
													<a
														href="<!-{$baseSet.url_base}->/item/<!-{$showPage.arrWowAhData[arrid].item}->"
													...
													<br />
													<a
														href="<!-{$baseSet.url_base}->/character/<!-{$showPage.arrWowAhData[arrid].ownerRealm}->/<!-{$showPage.arrWowAhData[arrid].owner}->/" target="block">
														<!-{$showPage.arrWowAhData[arrid].owner}->
													</a>
													<span class="sort-data hide"><a href="<!-{$baseSet.api_base}->/wow/item/<!-{$showPage.arrWowAhData[arrid].item}->"></a><!-{$showPage.arrWowAhData[arrid].item_quality}-> <!-{$showPage.arrWowAhData[arrid].item_name}-></span>
												</td>
												<td class="quantity">
