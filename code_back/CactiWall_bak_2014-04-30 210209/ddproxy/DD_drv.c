   ...
   )
{
   ...
   ULONG resultLength;
	...
	FUNC_KD_PRINT(("run func DDProxyLoadConfig!\n"));
   ...
   if (NT_SUCCESS(status))
   {
      ...
      ZwClose(registryKey);
   	...
   	FUNC_KD_PRINT(("end func DDProxyLoadConfig!\n"));
}
   ...
   )
{
   ...
   UINT conditionIndex;
	...
	FUNC_KD_PRINT(("run func DDProxyAddFilter!\n"));
   ...
   if (configInspectUdp && ADD_PORT_FILTER )
   {
      ...
      DEBG_STR_PRINT(("add remotePort filterConditions!"));
      conditionIndex++;
   }
   ...
   status = FwpmFilterAdd0(
	...
	FUNC_KD_PRINT(("end func DDProxyAddFilter!\n"));
   return status;
}
...
-- */
{
   ...
   BOOLEAN calloutRegistered = FALSE;
	...
	FUNC_KD_PRINT(("run func DDProxyRegisterFlowEstablishedCallouts!\n"));
   ...
   if (!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("end func DDProxyRegisterFlowEstablishedCallouts!\n"));
   return status;
...
Exit:
   ...
   if (!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("err func DDProxyRegisterFlowEstablishedCallouts!\n"));
   return status;
}
...
-- */
{
   ...
   BOOLEAN calloutRegistered = FALSE;
	...
	FUNC_KD_PRINT(("run func DDProxyRegisterDatagramDataCallouts!\n"));
   ...
   if (!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("err func DDProxyRegisterDatagramDataCallouts!\n"));
   return status;
Exit:
...
-- */
{
   ...
   FWPM_SESSION0 session = {0};
	...
	FUNC_KD_PRINT(("run func DDProxyRegisterCallouts!\n"));
   ...
   if (!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("end func DDProxyRegisterCallouts!\n"));
   return status;
...
Exit:
   ...
   if (!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("err func DDProxyRegisterCallouts!\n"));
   return status;
}
...
{
	FUNC_KD_PRINT(("run func DDProxyUnregisterCallouts!\n"));
   FwpmEngineClose0(gEngineHandle);
   gEngineHandle = NULL;
   ...
   FwpsCalloutUnregisterById0(gFlowEstablishedCalloutIdV4);
   	FUNC_KD_PRINT(("end func DDProxyUnregisterCallouts!\n"));
}

void
DDProxyRemoveFlows()
{
	FUNC_KD_PRINT(("run func DDProxyRemoveFlows!\n"));
   ...
   while (!IsListEmpty(&gFlowList))
   {
	...
	FUNC_KD_PRINT(("end func DDProxyRemoveFlows!\n"));
}
   ...
   )
{
   ...
   KLOCK_QUEUE_HANDLE flowListLockHandle;
	...
	FUNC_KD_PRINT(("run func DriverUnload!\n"));
   ...
   IoDeleteDevice(gDeviceObject);
   	...
   	FUNC_KD_PRINT(("end func DriverUnload!\n"));
}
   ...
   )
{
   ...
   HANDLE threadHandle;
	...
	FUNC_KD_PRINT(("run func DriverEntry!\n"));
...
Exit:
   ...
   if (!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("err func DriverUnload!\n"));
   return status;
}
