...
{
	FUNC_KD_PRINT(("run func DDProxyFreePendedPacket!\n"));
   ...
   ExFreePoolWithTag(packet, DD_PROXY_PENDED_PACKET_POOL_TAG);
   	...
   	FUNC_KD_PRINT(("end func DDProxyFreePendedPacket!\n"));
}
...
-- */
{
   ...
   DD_PROXY_FLOW_CONTEXT* flowContextLocal = NULL;
	...
	FUNC_KD_PRINT(("run func DDProxyFlowEstablishedClassify!\n"));
   ...
   if(!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("end func DDProxyFlowEstablishedClassify!\n"));
   return;
Exit:
   ...
   if(!NT_SUCCESS(status))
   {
	...
	FUNC_KD_PRINT(("err func DDProxyFlowEstablishedClassify!\n"));
   return;
}
...
{
	FUNC_KD_PRINT(("run func DDProxyFlowEstablishedNotify!\n"));
	
   UNREFERENCED_PARAMETER(notifyType);
   UNREFERENCED_PARAMETER(filterKey);
   UNREFERENCED_PARAMETER(filter);

	FUNC_KD_PRINT(("end func DDProxyFlowEstablishedNotify!\n"));
...
-- */
{
   ...
   BOOLEAN signalWorkerThread;
   	...
   	FUNC_KD_PRINT(("run func DDProxyClassify!\n"));
   ...
   if (packet != NULL)
   {
	...
	FUNC_KD_PRINT(("end func DDProxyClassify!\n"));
   return;
...
Exit:
   ...
   if (packet != NULL)
   {
	...
	FUNC_KD_PRINT(("err func DDProxyClassify!\n"));
   return;
}
...
{
	FUNC_KD_PRINT(("run func DDProxyNotify!\n"));
   UNREFERENCED_PARAMETER(notifyType);
   UNREFERENCED_PARAMETER(filterKey);
   UNREFERENCED_PARAMETER(filter);
   
	FUNC_KD_PRINT(("end func DDProxyNotify!\n"));
   return STATUS_SUCCESS;
}
...
-- */
{
   ...
   KLOCK_QUEUE_HANDLE flowListLockHandle;
	...
	FUNC_KD_PRINT(("run func DDProxyFlowDelete!\n"));
   ...
   DDProxyDereferenceFlowContext(flowContextLocal);
	FUNC_KD_PRINT(("end func DDProxyFlowDelete!\n"));
}
   ...
   )
{
   DD_PROXY_PENDED_PACKET* packet = context;
   	...
   	FUNC_KD_PRINT(("run func DDProxyInjectComplete!\n"));
   ...
   DDProxyFreePendedPacket(packet);
	...
	FUNC_KD_PRINT(("end func DDProxyInjectComplete!\n"));
}
...
-- */
{
   ...
   FWPS_TRANSPORT_SEND_PARAMS0 sendArgs = {0};
	...
	FUNC_KD_PRINT(("run func DDProxyCloneModifyReinjectOutbound!\n"));
   ...
   // Check to see if port modification is required.
      DEBG_STR_PRINT(("out packet->protocol:%d , addr:%d (%d)!",packet->belongingFlow->protocol,packet->belongingFlow->toRemoteAddr,&packet->remoteAddr));
   //
       ...
       (packet->belongingFlow->toRemotePort != 0))
   {
      NET_BUFFER* netBuffer;
	   ...
	   DEBG_STR_PRINT(("out IPPROTO_UDP packet!"));
   ...
   if ((packet->belongingFlow->protocol == IPPROTO_TCP) && 
       (packet->belongingFlow->toRemotePort != 0))
   {
      NET_BUFFER* netBuffer;
      
	   DEBG_STR_PRINT(("out IPPROTO_TCP packet!"));
           ...
           netBuffer = NET_BUFFER_NEXT_NB(netBuffer))
      {
         ...
         tcpHeader->destPort = packet->belongingFlow->toRemotePort;
   ...
   if (clonedNetBufferList != NULL)
   {
	...
	FUNC_KD_PRINT(("end func DDProxyCloneModifyReinjectOutbound!\n"));
   return status;
...
Exit:
   ...
   if (clonedNetBufferList != NULL)
   {
	...
	FUNC_KD_PRINT(("err func DDProxyCloneModifyReinjectOutbound!\n"));
   return status;
}
...
-- */
{
   ...
   ULONG nblOffset;
	...
	FUNC_KD_PRINT(("run func DDProxyCloneModifyReinjectInbound!\n"));
   ...
   //
   // Check to see if port modification is required.
   DEBG_STR_PRINT(("in packet->protocol:%d , addr:%d!",packet->belongingFlow->protocol,packet->belongingFlow->toRemoteAddr));
   //
   if ((packet->belongingFlow->protocol == IPPROTO_UDP ) && 
       (packet->belongingFlow->toRemotePort != 0))
   {
	    DEBG_STR_PRINT(("in IPPROTO_UDP packet!"));
   ...
   if ((packet->belongingFlow->protocol == IPPROTO_TCP ) && 
       (packet->belongingFlow->toRemotePort != 0))
   {
	   DEBG_STR_PRINT(("in IPPROTO_TCP packet!"));
   ...
   if (clonedNetBufferList != NULL)
   {
	...
	FUNC_KD_PRINT(("end func DDProxyCloneModifyReinjectInbound!\n"));
   return status;
...
Exit:
   ...
   if (clonedNetBufferList != NULL)
   {
	...
	FUNC_KD_PRINT(("err func DDProxyCloneModifyReinjectInbound!\n"));
   return status;
}
...
-- */
{
   ...
   KLOCK_QUEUE_HANDLE packetQueueLockHandle;
	...
	FUNC_KD_PRINT(("run func DDProxyWorker!\n"));
   ...
   PsTerminateSystemThread(STATUS_SUCCESS);
	...
	FUNC_KD_PRINT(("end func DDProxyWorker!\n"));
}
